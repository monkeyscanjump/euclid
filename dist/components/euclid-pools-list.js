...
import { d as defineCustomElement$6 } from './p-bUJ-P9iR.js';
import { d as defineCustomElement$5 } from './p-CVna4uH4.js';
import { d as defineCustomElement$4 } from './p-CMDQrBEs.js';
import { d as defineCustomElement$3 } from './p-Bd_LDF0j.js';
import { d as defineCustomElement$2 } from './p-DQ_T5-ak.js';
...
const EuclidPoolsList$1 = /*@__PURE__*/ proxyCustomElement(class EuclidPoolsList extends H {
    ...
    static get style() { return euclidPoolsListCss; }
}, [257, "euclid-pools-list", {
        "pools": [16],
        "tokenMetadata": [16],
        "positions": [16],
        "loading": [4],
...
function defineCustomElement$1() {
    ...
    const components = ["euclid-pools-list", "euclid-button", "pool-item", "pools-filters", "pools-loading", "pools-stats"];
    components.forEach(tagName => { switch (tagName) {
        case "euclid-pools-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, EuclidPoolsList$1);
            }
            break;
        case "euclid-button":
            if (!customElements.get(tagName)) {
...
const EuclidPoolsList = EuclidPoolsList$1;
const defineCustomElement = defineCustomElement$1;

export { EuclidPoolsList, defineCustomElement };
