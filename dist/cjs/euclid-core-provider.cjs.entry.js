...
const EuclidCoreProvider = class {
    constructor(hostRef) {
        ...
        this.handleWalletConnectFromModal = (event) => {
            ...
            events.dispatchEuclidEvent(events.EUCLID_EVENTS.WALLET.CONNECT_REQUEST, {
        ...
        this.handleTokenSelectFromModal = (event) => {
            ...
            events.dispatchEuclidEvent(events.EUCLID_EVENTS.UI.TOKEN_SELECTED, {
                tokenId: token.id,
                data: token
            });
    ...
    async initialize() {
        ...
        app_store.appStore.initialize();
        // Initialize wallet store
        wallet_store.walletStore.initialize();
    ...
    async loadInitialMarketData() {
        ...
        events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.LOAD_INITIAL);
    }
    ...
    render() {
        return (index.h(index.Host, { key: 'ff16368b7e9fdcd6fb93ff8881a7f3e12a48d204' }, !this.isInitialized && (index.h("div", { key: 'ade166583958c3f441ca395e39afe3716282381d', class: "euclid-loading" }, index.h("div", { key: '032bd8901b7471cd789a815a8818f991bb46d36e', class: "loading-spinner" }), index.h("p", { key: '579490fa607edc29c94abb24f96c5edba863854c' }, "Initializing Euclid Protocol..."))), index.h("euclid-wallet-controller", { key: '474d417b17c231f5ad20cdebf02ed783d54b7146' }), index.h("euclid-market-data-controller", { key: 'fd3407339e8cd9a4d7e0f44f753da04f6d1f97c0' }), index.h("euclid-user-data-controller", { key: '9b90a554c30bbd7d204e119ee854a7123160f6f6' }), index.h("euclid-swap-controller", { key: '2ed0b95b39cc2eae9027e525e37e56fd1b878f8b' }), index.h("euclid-liquidity-controller", { key: 'cf94a2d83e9a6cb9aa47b8dec2f5582b316e960a' }), index.h("euclid-tx-tracker-controller", { key: '2dcc971fd3cffd8fef9ddcb48a4d07d2f2b10140' }), index.h("euclid-modal", { key: 'b252d325fcd72f88e32a098841b7b5ee11319cd8' }), index.h("div", { key: '3d79c6936817ad87b0ccbadf2f50a8a77c565dd4', class: "euclid-provider-content" }, index.h("slot", { key: 'a4df73336ae4236aa3418bf72392b585aaeac366' }))));
    }
};
EuclidCoreProvider.style = euclidCoreProviderCss;

exports.euclid_core_provider = EuclidCoreProvider;
//# sourceMappingURL=euclid-core-provider.entry.cjs.js.map
