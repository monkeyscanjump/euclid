...
export class EuclidLiquidityController {
    ...
    static get is() { return "euclid-liquidity-controller"; }
    static get states() {
        return {
            "isInitialized": {}
        };
    ...
    static get listeners() {
        return [{
                "name": "euclid:liquidity:add-request",
                "method": "handleAddLiquidityExecution",
                "target": "window",
                "capture": false,
                "passive": false
            }, {
                "name": "euclid:liquidity:remove-request",
                "method": "handleRemoveLiquidityExecution",
                "target": "window",
                "capture": false,
                "passive": false
            }];
...
//# sourceMappingURL=euclid-liquidity-controller.js.map
