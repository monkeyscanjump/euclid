...
var app_store = require('./app.store-ec7wI-D_.js');
var constants = require('./constants-CupYHcN9.js');
var events = require('./events-RYcIo8H-.js');
...
const EuclidButton = class {
    ...
    render() {
        ...
        if (this.href && !this.disabled && !this.loading) {
            return (index.h(index.Host, null, index.h("a", { href: this.href, class: classes, role: "button", "aria-busy": this.loading ? 'true' : 'false' }, this.loading && (index.h("span", { class: "euclid-button__spinner", "aria-hidden": "true" }, index.h("svg", { viewBox: "0 0 24 24", class: "euclid-button__spinner-icon" }, index.h("circle", { cx: "12", cy: "12", r: "10", stroke: "currentColor", "stroke-width": "2", fill: "none", "stroke-linecap": "round", "stroke-dasharray": "60", "stroke-dashoffset": "60" })))), index.h("span", { class: { 'euclid-button__content': true, 'euclid-button__content--hidden': this.loading } }, index.h("slot", null)))));
        }
        // Render as button
        return (index.h(index.Host, null, index.h("button", { type: this.type, ...commonProps }, this.loading && (index.h("span", { class: "euclid-button__spinner", "aria-hidden": "true" }, index.h("svg", { viewBox: "0 0 24 24", class: "euclid-button__spinner-icon" }, index.h("circle", { cx: "12", cy: "12", r: "10", stroke: "currentColor", "stroke-width": "2", fill: "none", "stroke-linecap": "round", "stroke-dasharray": "60", "stroke-dashoffset": "60" })))), index.h("span", { class: { 'euclid-button__content': true, 'euclid-button__content--hidden': this.loading } }, index.h("slot", null)))));
    }
};
...
const EuclidLiquidityCard = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.liquidityAdded = index.createEvent(this, "liquidityAdded");
        this.liquidityRemoved = index.createEvent(this, "liquidityRemoved");
        this.poolSelected = index.createEvent(this, "poolSelected");
        this.quoteRequested = index.createEvent(this, "quoteRequested");
        /**
        ...
        this.handleLiquidity = () => {
            ...
            if (!this.isWalletConnectedForLiquidity()) {
                ...
                app_store.appStore.openWalletModal(chainUID);
                return;
            }
            ...
            constants.liquidityStore.setSelectedPool(apiPool);
            if (this.mode === 'add' && this.currentQuote) {
                // Set liquidity store values
                constants.liquidityStore.setToken1Amount(this.tokenAAmount);
                constants.liquidityStore.setToken2Amount(this.tokenBAmount);
                // Trigger add liquidity execution
                events.dispatchEuclidEvent(events.EUCLID_EVENTS.LIQUIDITY.ADD_REQUEST);
                ...
                events.dispatchEuclidEvent(events.EUCLID_EVENTS.LIQUIDITY.REMOVE_REQUEST, {
    ...
    componentWillLoad() {
        ...
        constants.marketStore.onChange('pools', () => {
            this.syncWithStore();
        });
        constants.marketStore.onChange('tokens', () => {
            this.syncWithStore();
        });
    }
    componentDidLoad() {
    ...
    syncWithStore() {
        ...
        this.storePools = constants.marketStore.state.pools.length > 0 ? constants.marketStore.state.pools : [];
        this.storeTokens = constants.marketStore.state.tokens.length > 0 ? constants.marketStore.state.tokens : [];
        this.storeLoading = constants.marketStore.state.loading;
    ...
    getFirstDisconnectedChain() {
        if (!this.selectedPool)
            return 'ethereum';
        const tokenAConnected = wallet_store.walletStore.isWalletConnected(this.selectedPool.tokenA.chainUID);
        if (!tokenAConnected)
    ...
    isWalletConnectedForLiquidity() {
        ...
        const tokenAConnected = wallet_store.walletStore.isWalletConnected(this.selectedPool.tokenA.chainUID);
        const tokenBConnected = wallet_store.walletStore.isWalletConnected(this.selectedPool.tokenB.chainUID);
    ...
    render() {
        const position = this.getUserPosition();
        return (index.h("div", { key: 'fbb27ab9ab7899320d28a125a7357c4e32fee744', class: "liquidity-card" }, index.h("div", { key: 'fbf92028cdeb8d065f319cd3a3f09727020c7bcb', class: "liquidity-header" }, index.h("h3", { key: '0457fcaa0a2682fa39e52c7693f944645e965c92', class: "liquidity-title" }, this.cardTitle), index.h("div", { key: 'd7a84e7900bb5fe29487733a1dccace61ba2a22d', class: "mode-toggle" }, index.h("button", { key: '4707d6117de7765b50a8c59149863fc368aafd40', class: {
                'mode-button': true,
                'mode-button--active': this.mode === 'add',
            }, onClick: () => this.handleModeChange('add'), type: "button" }, "Add"), index.h("button", { key: 'b8d4416d3be73a432f7d48c510e2e4cc64bd112a', class: {
                'mode-button': true,
                'mode-button--active': this.mode === 'remove',
            }, onClick: () => this.handleModeChange('remove'), type: "button" }, "Remove"))), index.h("div", { key: '56b5cf2bc51ca11c2dedfe9e947809644267ac5f', class: "pool-section" }, index.h("div", { key: 'fd6487086cfaaac4c86d0f54f6e34dea309e6f18', class: "section-header" }, index.h("span", { key: 'eee09fb8655432b11db1f34ef830474671c96cd7', class: "section-label" }, "Pool")), index.h("div", { key: 'fb48fc9f17857c928f4a621ec17d5af1d28bbf4c', class: "pool-selector", onClick: this.openPoolSelector }, this.selectedStorePool ? (index.h("div", { class: "selected-pool" }, index.h("div", { class: "pool-tokens" }, index.h("div", { class: "token-pair" }), index.h("div", { class: "pool-info" }, index.h("span", { class: "pool-name" }, this.selectedStorePool.token_1.toUpperCase(), "/", this.selectedStorePool.token_2.toUpperCase()), index.h("span", { class: "pool-fee" }, "Pool Fee"))), index.h("div", { class: "pool-stats" }, index.h("div", { class: "stat" }, index.h("span", { class: "stat-label" }, "APR"), index.h("span", { class: "stat-value" }, this.selectedStorePool.apr || 'N/A')), index.h("div", { class: "stat" }, index.h("span", { class: "stat-label" }, "TVL"), index.h("span", { class: "stat-value" }, "$", parseFloat(this.selectedStorePool.total_liquidity || '0').toLocaleString()))))) : (index.h("div", { class: "select-pool-button" }, index.h("span", null, "Select Pool"), index.h("svg", { class: "dropdown-arrow", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" })))))), this.mode === 'remove' && position && (index.h("div", { key: 'f1d3724de38d34aa7aa7790551963a175f33080c', class: "position-info" }, index.h("div", { key: 'b793920b80f4cb11354869133be1dbb3368ee079', class: "position-header" }, index.h("span", { key: '6a039b02cd1a9f74104ee34f682b9e64a9889e0b', class: "position-label" }, "Your Position")), index.h("div", { key: 'c97baf92a9754ae2fca115e03200e1f30bd1d448', class: "position-details" }, index.h("div", { key: 'd5fec46738c36828ef1ae3e6733a3cfa6a3a5039', class: "position-row" }, index.h("span", { key: '66ccbf9254ef55c51816ea721eaada7277acb54e', class: "position-item-label" }, "LP Tokens"), index.h("span", { key: '01d82005a28686c26139b6a93f9db14e16484bc6', class: "position-item-value" }, parseFloat(position.lpTokenBalance).toLocaleString())), index.h("div", { key: 'cbaa6637710172da8508e32cb411ee9a883a5751', class: "position-row" }, index.h("span", { key: '66de96f4f417063e59ed9482bfcaef9d0a91fb89', class: "position-item-label" }, "Pool Share"), index.h("span", { key: '520510c337fa67835da8f4a63e3d81ebc9ab5673', class: "position-item-value" }, position.shareOfPool.toFixed(4), "%")), index.h("div", { key: 'f8a5a350c9967d11fccac64b96dab8f9179cfcc9', class: "position-row" }, index.h("span", { key: '12317d6dcc609599a8453b45ab7ea87eecd69f8d', class: "position-item-label" }, this.selectedPool?.tokenA.symbol), index.h("span", { key: 'bf590312d1c965a3bdaef81b7ac96be2310a90d8', class: "position-item-value" }, parseFloat(position.tokenAAmount).toLocaleString())), index.h("div", { key: 'b227ba9463e21849bf88e354cc93b4fc23c823b5', class: "position-row" }, index.h("span", { key: 'e6e685d3a93801063d8848dacd4fba95c0ab9a6a', class: "position-item-label" }, this.selectedPool?.tokenB.symbol), index.h("span", { key: '64a27461ccffb52c6d0f629f36bc9335bbab6177', class: "position-item-value" }, parseFloat(position.tokenBAmount).toLocaleString()))))), this.mode === 'add' ? this.renderAddLiquidity() : this.renderRemoveLiquidity(), (this.currentQuote || this.removeQuote) && (index.h("div", { key: 'ef7494271ae36f29070fa062d7d43100ba49d7e9', class: "quote-info" }, this.mode === 'add' && this.currentQuote ? (index.h("div", null, index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, "LP Tokens Received"), index.h("span", { class: "quote-value" }, parseFloat(this.currentQuote.lpTokensReceived).toLocaleString())), index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, "Pool Share"), index.h("span", { class: "quote-value" }, this.currentQuote.shareOfPool.toFixed(4), "%")), this.currentQuote.priceImpact > 0.1 && (index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, "Price Impact"), index.h("span", { class: {
                'quote-value': true,
                'quote-value--warning': this.currentQuote.priceImpact > 1,
                'quote-value--danger': this.currentQuote.priceImpact > 3,
            } }, this.currentQuote.priceImpact.toFixed(3), "%"))))) : this.mode === 'remove' && this.removeQuote ? (index.h("div", null, index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, "Pool Share Removed"), index.h("span", { class: "quote-value" }, this.removeQuote.shareRemoved.toFixed(4), "%")), index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, this.selectedPool?.tokenA.symbol, " Received"), index.h("span", { class: "quote-value" }, parseFloat(this.removeQuote.tokenAReceived).toLocaleString())), index.h("div", { class: "quote-row" }, index.h("span", { class: "quote-label" }, this.selectedPool?.tokenB.symbol, " Received"), index.h("span", { class: "quote-value" }, parseFloat(this.removeQuote.tokenBReceived).toLocaleString())))) : null)), index.h("div", { key: '612805e4dddc9b1d1503b2476c0835b537e45968', class: "advanced-section" }, index.h("button", { key: 'ad062b6527a84920b912099a6d07c1613b71b4f3', class: "advanced-toggle", onClick: () => this.isAdvancedOpen = !this.isAdvancedOpen, type: "button" }, index.h("span", { key: 'b239f7a654cfacfdd225029d7cdea88429635350' }, "Advanced Settings"), index.h("svg", { key: '2aca2842f79e015832b8fb9c4a594b852a9ba81a', class: {
                'dropdown-arrow': true,
                'dropdown-arrow--open': this.isAdvancedOpen,
            }, viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { key: '8f4ae78087449d10dbde50628e78f179e224deee', d: "M7 10l5 5 5-5z" }))), this.isAdvancedOpen && (index.h("div", { key: 'b909234c6b44aac120d18cb0f797435b0ab8245d', class: "advanced-panel" }, index.h("div", { key: '7342fd5ea77e7d945feec2f4510b3a309e3e95aa', class: "setting-item" }, index.h("label", { key: 'b97fd6799eb2975469fb3e08c82eef62126d277f', class: "setting-label" }, "Slippage Tolerance"), index.h("div", { key: 'ee935980b4cfa704266d03c2f9864ebbef1089f1', class: "slippage-controls" }, [0.1, 0.5, 1.0].map((value) => (index.h("button", { class: {
                'slippage-btn': true,
                'slippage-btn--active': this.slippage === value,
            }, onClick: () => this.slippage = value, type: "button" }, value, "%"))), index.h("input", { key: 'c3be315b32b031876d88b469fd30f31c4587942f', class: "slippage-input", type: "number", min: "0", max: "50", step: "0.1", value: this.slippage, onInput: (e) => this.slippage = parseFloat(e.target.value), placeholder: "Custom" })))))), index.h("euclid-button", { key: '5944b56e76e00b59e4c672263de5eb2664a711f8', variant: "primary", size: "lg", "full-width": true, loading: this.loading, disabled: !this.canExecute(), onClick: this.handleLiquidity }, this.getButtonText()), this.isPoolSelectorOpen && (index.h("div", { key: '978c72fc4bbc424f2a0973540ceb27395bb34218', class: "pool-selector-dropdown" }, index.h("div", { key: '5ce5d143a9531899947f2a41a26647828a4f7f0f', class: "dropdown-header" }, index.h("h4", { key: '1218a0301d481810ae011c6e781ef1f10584709b' }, "Select Pool"), index.h("button", { key: '36927bc8368749e8b4cf3a740d6f99d26b55c57e', class: "close-button", onClick: () => this.isPoolSelectorOpen = false }, "\u00D7")), index.h("div", { key: 'f8bd7d24e6ff2e0780558293ca574d0405cf1b22', class: "pool-list" }, this.storePools.length > 0 ? (this.storePools.map(pool => (index.h("div", { key: pool.pool_id, class: "pool-item", onClick: () => this.selectStorePool(pool) }, index.h("div", { class: "pool-tokens" }, index.h("span", { class: "pool-name" }, pool.token_1.toUpperCase(), "/", pool.token_2.toUpperCase())), index.h("div", { class: "pool-stats" }, index.h("span", { class: "apr" }, "APR: ", pool.apr || '0.00%'), index.h("span", { class: "tvl" }, "TVL: $", parseFloat(pool.total_liquidity || '0').toLocaleString())))))) : (index.h("div", { class: "no-pools" }, "No pools available")))))));
    }
    renderAddLiquidity() {
        return (index.h("div", { class: "liquidity-inputs" }, index.h("div", { class: "token-input-section" }, index.h("div", { class: "input-header" }, index.h("span", { class: "input-label" }, "First Token"), this.selectedPool?.tokenA.balance && (index.h("span", { class: "balance-label", onClick: () => this.handleMaxClick('tokenA') }, "Balance: ", parseFloat(this.selectedPool.tokenA.balance).toLocaleString()))), index.h("euclid-token-input", { id: "token-a-input", value: this.tokenAAmount, placeholder: "0.0", "show-max": !!this.selectedPool?.tokenA.balance, onMaxClick: () => this.handleMaxClick('tokenA') }, index.h("div", { slot: "token", class: "token-display" }, this.selectedStorePool ? (index.h("div", { class: "selected-token" }, index.h("div", { class: "token-info" }, index.h("span", { class: "token-symbol" }, this.selectedStorePool.token_1.toUpperCase()), index.h("span", { class: "token-name" }, this.selectedStorePool.token_1)))) : (index.h("div", { class: "no-pool-selected" }, index.h("span", { class: "token-symbol" }, "TOKEN"), index.h("span", { class: "token-name" }, "Select pool first")))))), index.h("div", { class: "token-input-section" }, index.h("div", { class: "input-header" }, index.h("span", { class: "input-label" }, "Second Token"), this.selectedPool?.tokenB.balance && (index.h("span", { class: "balance-label", onClick: () => this.handleMaxClick('tokenB') }, "Balance: ", parseFloat(this.selectedPool.tokenB.balance).toLocaleString()))), index.h("euclid-token-input", { id: "token-b-input", value: this.tokenBAmount, placeholder: "0.0", "show-max": !!this.selectedPool?.tokenB.balance, onMaxClick: () => this.handleMaxClick('tokenB') }, index.h("div", { slot: "token", class: "token-display" }, this.selectedStorePool ? (index.h("div", { class: "selected-token" }, index.h("div", { class: "token-info" }, index.h("span", { class: "token-symbol" }, this.selectedStorePool.token_2.toUpperCase()), index.h("span", { class: "token-name" }, this.selectedStorePool.token_2)))) : (index.h("div", { class: "no-pool-selected" }, index.h("span", { class: "token-symbol" }, "TOKEN"), index.h("span", { class: "token-name" }, "Select pool first"))))))));
    }
    renderRemoveLiquidity() {
        const position = this.getUserPosition();
        return (index.h("div", { class: "remove-liquidity" }, index.h("div", { class: "percentage-section" }, index.h("div", { class: "percentage-label" }, "Amount to Remove"), index.h("div", { class: "percentage-buttons" }, [25, 50, 75, 100].map((percent) => (index.h("button", { class: {
                'percentage-btn': true,
                'percentage-btn--active': this.lpPercentage === percent,
            }, onClick: () => this.handlePercentageClick(percent), type: "button" }, percent, "%"))))), index.h("div", { class: "token-input-section" }, index.h("div", { class: "input-header" }, index.h("span", { class: "input-label" }, "LP Tokens to Remove"), position && (index.h("span", { class: "balance-label", onClick: () => this.handleMaxClick('lp') }, "Balance: ", parseFloat(position.lpTokenBalance).toLocaleString()))), index.h("euclid-token-input", { id: "lp-token-input", value: this.lpTokenAmount, placeholder: "0.0", "show-max": !!position, onMaxClick: () => this.handleMaxClick('lp') }, index.h("div", { slot: "token", class: "lp-token-display" }, this.selectedPool ? (index.h("div", { class: "lp-token-info" }, index.h("div", { class: "token-pair" }, this.selectedPool.tokenA.logoUrl && (index.h("img", { src: this.selectedPool.tokenA.logoUrl, alt: this.selectedPool.tokenA.symbol, class: "token-logo" })), this.selectedPool.tokenB.logoUrl && (index.h("img", { src: this.selectedPool.tokenB.logoUrl, alt: this.selectedPool.tokenB.symbol, class: "token-logo token-logo--overlap" }))), index.h("span", { class: "lp-symbol" }, this.selectedPool.lpTokenSymbol))) : (index.h("span", null, "Select Pool")))))));
    }
...
const EuclidMarketDataController = class {
    ...
    async loadInitialData() {
        try {
            constants.marketStore.setLoading(true);
            console.log('📊 Loading initial market data...');
            // Load chains
            const chainsResponse = await constants.apiClient.getAllChains(false);
            if (chainsResponse.success && chainsResponse.data) {
                // Store the EuclidChainConfig[] data directly
                constants.marketStore.setChains(chainsResponse.data);
            ...
            // Load tokens
            const tokensResponse = await constants.apiClient.getAllTokens();
            if (tokensResponse.success && tokensResponse.data) {
                // Store the TokenMetadata[] data directly
                constants.marketStore.setTokens(tokensResponse.data);
            ...
            // Load pools
            const poolsResponse = await constants.apiClient.getAllPools();
            if (poolsResponse.success && poolsResponse.data) {
                constants.marketStore.setPools(poolsResponse.data);
            ...
            constants.marketStore.setLoading(false);
        }
    }
    setupPeriodicRefresh() {
        // Refresh market data every 5 minutes
        this.refreshInterval = window.setInterval(async () => {
            if (constants.marketStore.isDataStale()) {
                console.log('🔄 Refreshing stale market data...');
                await this.refreshMarketData();
            }
        }, constants.DEFAULTS.MARKET_DATA_REFRESH_INTERVAL);
    }
    ...
    async handleTokenDetailsRequest(event) {
        ...
        try {
            ...
            const denomsResponse = await constants.apiClient.getTokenDenoms(tokenId);
            if (denomsResponse.success && denomsResponse.data) {
                ...
                events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.TOKEN_DETAILS_SUCCESS, {
                    tokenId,
                    data: { denoms }
                });
            }
            // Get escrow information
            const escrowsResponse = await constants.apiClient.getEscrows(tokenId);
            if (escrowsResponse.success && escrowsResponse.data) {
                ...
                events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.ESCROWS_LOADED, {
                    tokenId,
                    data: { escrows }
                });
            }
            ...
            events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.TOKEN_DETAILS_FAILED, {
                tokenId,
                error: error.message
            });
        }
    ...
    async handleChainDetailsRequest(event) {
        ...
        try {
            ...
            const chain = constants.marketStore.getChain(chainUID);
            if (chain) {
                // Emit chain details loaded event
                events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.CHAIN_DETAILS_SUCCESS, {
                    chainUID,
                    data: { chain }
                });
            }
            ...
            events.dispatchEuclidEvent(events.EUCLID_EVENTS.MARKET.CHAIN_DETAILS_FAILED, {
                chainUID,
                error: error.message
            });
        }
...
const EuclidModal = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.appState = app_store.appStore.state;
    ...
    componentWillLoad() {
        ...
        console.log('📊 Initial store state:', app_store.appStore.state);
        // Calculate scrollbar width for body scroll prevention
        this.scrollBarWidth = this.getScrollBarWidth();
        console.log('📏 Scrollbar width:', this.scrollBarWidth);
        app_store.appStore.onChange('walletModalOpen', () => {
            console.log('👛 Wallet modal state changed:', app_store.appStore.state.walletModalOpen);
            const wasOpen = this.appState.walletModalOpen || this.appState.tokenModalOpen;
            const newState = { ...app_store.appStore.state };
        ...
        app_store.appStore.onChange('tokenModalOpen', () => {
            console.log('🪙 Token modal state changed:', app_store.appStore.state.tokenModalOpen);
            const wasOpen = this.appState.walletModalOpen || this.appState.tokenModalOpen;
            const newState = { ...app_store.appStore.state };
            const isNowOpen = newState.walletModalOpen || newState.tokenModalOpen;
            this.appState = newState;
    ...
    closeModal() {
        app_store.appStore.closeWalletModal();
        app_store.appStore.closeTokenModal();
    }
    /**
    ...
    render() {
        ...
        if (this.appState.walletModalOpen) {
            ...
            content = index.h("euclid-wallet-content", null);
            console.log('👛 Rendering wallet modal');
        }
        else if (this.appState.tokenModalOpen) {
            title = 'Select Token';
            content = index.h("euclid-token-content", null);
            console.log('🪙 Rendering token modal');
        }
        return (index.h("div", { class: "modal-overlay", onClick: this.handleOverlayClick, role: "dialog", "aria-modal": "true", "aria-hidden": "false" }, index.h("div", { class: "modal-container", role: "document", tabindex: "-1", "aria-labelledby": "modal-title", "aria-describedby": "modal-content" }, index.h("div", { class: "modal-header" }, index.h("h2", { id: "modal-title", class: "modal-title" }, title), index.h("button", { class: "close-button", onClick: () => this.closeModal(), type: "button", "aria-label": "Close modal" }, index.h("svg", { viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true" }, index.h("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" })))), index.h("div", { id: "modal-content", class: "modal-content" }, content))));
    }
...
const EuclidPoolsList = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.poolSelected = index.createEvent(this, "poolSelected");
        this.addLiquidity = index.createEvent(this, "addLiquidity");
        this.removeLiquidity = index.createEvent(this, "removeLiquidity");
        this.stakeTokens = index.createEvent(this, "stakeTokens");
        this.claimRewards = index.createEvent(this, "claimRewards");
        this.filtersChanged = index.createEvent(this, "filtersChanged");
        /**
    ...
    syncWithStore() {
        ...
        this.storePools = constants.marketStore.state.pools.length > 0 ? constants.marketStore.state.pools : this.pools;
        this.storeTokens = constants.marketStore.state.tokens.length > 0 ? constants.marketStore.state.tokens : this.tokenMetadata;
        this.storeLoading = constants.marketStore.state.loading;
        // Debug logging
        console.log('🔄 Store sync:', {
            ...
            storeTokens: this.storeTokens.length,
            storeLoading: this.storeLoading,
            marketStorePools: constants.marketStore.state.pools.length,
            marketStoreTokens: constants.marketStore.state.tokens.length,
            marketStoreLoading: constants.marketStore.state.loading
        });
    }
    watchPoolsChange() {
        this.applyFilters();
    ...
    render() {
        ...
        return (index.h("div", { key: 'ee8cd3221635ae068a8d7707c128ccc51ad98bdf', class: "pools-list" }, index.h("div", { key: '8c5a36dff34b3662a569719e700229587ec4cd08', class: "pools-header" }, index.h("h3", { key: '49ca59d21d81ff5b17209ce984fc080002ec64e0', class: "pools-title" }, this.cardTitle)), index.h("pools-filters", { key: '9d006a402943b6c13ee75b1f4207b2799a5baed2', filters: this.filters, walletAddress: this.walletAddress, onFiltersChanged: this.handleFiltersChanged }), index.h("pools-stats", { key: 'b26ac8b9520425a46cd58748cf227043154ae434', totalPools: activePools.length, filteredPools: this.filteredPools.length, totalTvl: totalTvl, userPositions: this.positions.length, walletAddress: this.walletAddress }), index.h("div", { key: '9ec301d9c1053070d22f5a69981ee9dd80da3a98', class: "pools-content" }, isLoading ? (index.h("pools-loading", { count: 6 })) : paginatedPools.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 64 64", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M31.968,0c-1.9626667,28.448-3.552,29.984-32,32c28.448,1.9626667,29.984,3.552,32,32c1.9626667-28.448,3.552-29.984,32-32C35.52,29.984,33.9306667,28.448,31.968,0z" })), index.h("span", null, "No pools found matching your criteria"), index.h("button", { class: "clear-filters-btn", onClick: () => {
                this.filters = {
                    search: '',
                    sortBy: 'apr',
                    sortOrder: 'desc',
                ...
                this.currentPage = 1;
                this.applyFilters();
            }, type: "button" }, "Clear Filters"))) : (index.h("div", { class: "pools-grid" }, paginatedPools.map(pool => (index.h("pool-item", { key: pool.pool_id, pool: pool, tokens: activeTokens, position: this.getUserPosition(pool.pool_id), walletAddress: this.walletAddress, onAddLiquidity: (event) => this.addLiquidity.emit(event.detail), onRemoveLiquidity: (event) => this.removeLiquidity.emit(event.detail), onStakeTokens: (event) => this.stakeTokens.emit(event.detail), onClaimRewards: (event) => this.claimRewards.emit(event.detail) })))))), this.totalPages > 1 && (index.h("div", { key: '00ef8872b32c0a7026641101bd5c141dad963efa', class: "pagination" }, index.h("button", { key: '515f5f02ee25ad9002bab9480fe3094fbbf2a9bb', class: "pagination-btn", onClick: () => this.handlePageChange(this.currentPage - 1), disabled: this.currentPage === 1, type: "button" }, "Previous"), index.h("div", { key: 'a02e9fd63fa1ecbc01ffd6a89f1760e708ecb1a5', class: "pagination-pages" }, Array.from({ length: this.totalPages }, (_, i) => i + 1).map(page => (index.h("button", { key: page, class: {
                'pagination-page': true,
                'pagination-page--active': page === this.currentPage,
            }, onClick: () => this.handlePageChange(page), type: "button" }, page)))), index.h("button", { key: 'a1a783aa40ef3a16416a35e804aa1d25608c82a5', class: "pagination-btn", onClick: () => this.handlePageChange(this.currentPage + 1), disabled: this.currentPage === this.totalPages, type: "button" }, "Next")))));
    }
...
const EuclidPortfolioOverview = class {
    constructor(hostRef) {
        ...
        this.managePosition = index.createEvent(this, "managePosition");
        this.stakeMore = index.createEvent(this, "stakeMore");
        this.unstake = index.createEvent(this, "unstake");
        this.claimRewards = index.createEvent(this, "claimRewards");
        this.viewTransaction = index.createEvent(this, "viewTransaction");
        this.timePeriodChanged = index.createEvent(this, "timePeriodChanged");
        /**
    ...
    renderOverviewTab() {
        ...
        if (!stats)
            return null;
        return (index.h("div", { class: "overview-tab" }, index.h("div", { class: "stats-grid" }, index.h("div", { class: "stat-card" }, index.h("div", { class: "stat-label" }, "Total Value"), index.h("div", { class: "stat-value" }, "$", this.formatNumber(stats.totalValue)), index.h("div", { class: {
                'stat-change': true,
                'stat-change--positive': stats.dayChange >= 0,
                'stat-change--negative': stats.dayChange < 0,
            } }, this.formatPercent(stats.dayChangePercent), " (24h)")), index.h("div", { class: "stat-card" }, index.h("div", { class: "stat-label" }, "Total P&L"), index.h("div", { class: {
                'stat-value': true,
                'stat-value--positive': stats.totalPnL >= 0,
                'stat-value--negative': stats.totalPnL < 0,
            } }, "$", this.formatNumber(stats.totalPnL)), index.h("div", { class: {
                'stat-change': true,
                'stat-change--positive': stats.totalPnLPercent >= 0,
                'stat-change--negative': stats.totalPnLPercent < 0,
            } }, this.formatPercent(stats.totalPnLPercent))), index.h("div", { class: "stat-card" }, index.h("div", { class: "stat-label" }, "Total Rewards"), index.h("div", { class: "stat-value" }, "$", this.formatNumber(stats.totalRewards)), index.h("div", { class: "stat-change" }, stats.activePositions, " active positions")), index.h("div", { class: "stat-card" }, index.h("div", { class: "stat-label" }, "Total Staked"), index.h("div", { class: "stat-value" }, "$", this.formatNumber(stats.totalStaked)), index.h("div", { class: "stat-change" }, this.stakingPositions.length, " staking positions"))), this.showAnalytics && (index.h("div", { class: "chart-section" }, index.h("div", { class: "chart-header" }, index.h("h3", null, "Portfolio Value"), index.h("div", { class: "time-period-selector" }, ['1D', '1W', '1M', '3M', '1Y', 'ALL'].map(period => (index.h("button", { key: period, class: {
                'period-btn': true,
                'period-btn--active': period === this.timePeriod,
            }, onClick: () => this.handleTimePeriodChange(period), type: "button" }, period))))), index.h("div", { class: "chart-container" }))), index.h("div", { class: "allocation-section" }, index.h("h3", null, "Asset Allocation"), index.h("div", { class: "allocation-grid" }, this.tokenBalances
            .filter(token => token.value > 0)
            .sort((a, b) => b.value - a.value)
            .slice(0, 6)
            .map(token => (index.h("div", { key: token.symbol, class: "allocation-item" }, index.h("div", { class: "token-info" }, token.logoUrl && (index.h("img", { src: token.logoUrl, alt: token.symbol, class: "token-logo" })), index.h("div", { class: "token-details" }, index.h("div", { class: "token-symbol" }, token.symbol), index.h("div", { class: "token-balance" }, parseFloat(token.balance).toFixed(4)))), index.h("div", { class: "token-value" }, index.h("div", { class: "value-primary" }, "$", this.formatNumber(token.value)), index.h("div", { class: "allocation-percent" }, token.allocation.toFixed(1), "%")), index.h("div", { class: {
                'price-change': true,
    ...
    renderPositionsTab() {
        ...
        return (index.h("div", { class: "positions-tab" }, index.h("div", { class: "positions-header" }, index.h("h3", null, "Liquidity Positions"), index.h("div", { class: "sort-controls" }, index.h("button", { class: {
                'sort-btn': true,
                'sort-btn--active': this.sortBy === 'value',
            }, onClick: () => this.handleSortChange('value'), type: "button" }, "Value", this.sortBy === 'value' && (index.h("svg", { class: {
                'sort-arrow': true,
                'sort-arrow--desc': this.sortOrder === 'desc',
            }, viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" })))), index.h("button", { class: {
                'sort-btn': true,
                'sort-btn--active': this.sortBy === 'apy',
            }, onClick: () => this.handleSortChange('apy'), type: "button" }, "APY"))), index.h("div", { class: "positions-list" }, sortedPositions.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,17A1.5,1.5 0 0,0 13.5,15.5A1.5,1.5 0 0,0 12,14A1.5,1.5 0 0,0 10.5,15.5A1.5,1.5 0 0,0 12,17M12,10.5C12.8,10.5 13.5,9.8 13.5,9C13.5,8.2 12.8,7.5 12,7.5C11.2,7.5 10.5,8.2 10.5,9C10.5,9.8 11.2,10.5 12,10.5Z" })), index.h("span", null, "No liquidity positions found"))) : (sortedPositions.map(position => (index.h("div", { key: position.poolId, class: "position-card", onClick: () => this.handlePositionClick(position) }, index.h("div", { class: "position-header" }, index.h("div", { class: "token-pair" }, position.tokenA.logoUrl && (index.h("img", { src: position.tokenA.logoUrl, alt: position.tokenA.symbol, class: "token-logo" })), position.tokenB.logoUrl && (index.h("img", { src: position.tokenB.logoUrl, alt: position.tokenB.symbol, class: "token-logo token-logo--overlap" })), index.h("span", { class: "pair-name" }, position.tokenA.symbol, "/", position.tokenB.symbol)), index.h("div", { class: "position-value" }, "$", this.formatNumber(position.totalValue))), index.h("div", { class: "position-details" }, index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "APY"), index.h("span", { class: "detail-value apy-value" }, position.apy.toFixed(2), "%")), index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "Share"), index.h("span", { class: "detail-value" }, position.shareOfPool.toFixed(4), "%")), index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "IL"), index.h("span", { class: {
                'detail-value': true,
                'detail-value--positive': position.impermanentLoss >= 0,
                'detail-value--negative': position.impermanentLoss < 0,
            } }, this.formatPercent(position.impermanentLoss)))), (position.unclaimedRewards || position.stakingRewards) && (index.h("div", { class: "rewards-section" }, position.unclaimedRewards && position.unclaimedRewards > 0 && (index.h("div", { class: "reward-item" }, index.h("span", null, "Unclaimed: $", this.formatNumber(position.unclaimedRewards)), index.h("euclid-button", { variant: "ghost", size: "sm", onClick: (e) => {
                e.stopPropagation();
                this.handleClaimRewards(position);
            } }, "Claim"))), position.stakingRewards && position.stakingRewards > 0 && (index.h("div", { class: "reward-item" }, index.h("span", null, "Staking: $", this.formatNumber(position.stakingRewards)))))), index.h("div", { class: "position-actions" }, index.h("euclid-button", { variant: "secondary", size: "sm", onClick: (e) => {
                e.stopPropagation();
                this.handleManagePosition(position);
            } }, "Manage")))))))));
    }
    renderStakingTab() {
        return (index.h("div", { class: "staking-tab" }, index.h("div", { class: "staking-header" }, index.h("h3", null, "Staking Positions")), index.h("div", { class: "staking-list" }, this.stakingPositions.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,17A1.5,1.5 0 0,0 13.5,15.5A1.5,1.5 0 0,0 12,14A1.5,1.5 0 0,0 10.5,15.5A1.5,1.5 0 0,0 12,17M12,10.5C12.8,10.5 13.5,9.8 13.5,9C13.5,8.2 12.8,7.5 12,7.5C11.2,7.5 10.5,8.2 10.5,9C10.5,9.8 11.2,10.5 12,10.5Z" })), index.h("span", null, "No staking positions found"))) : (this.stakingPositions.map(position => (index.h("div", { key: position.id, class: "staking-card" }, index.h("div", { class: "staking-header" }, index.h("div", { class: "token-info" }, index.h("span", { class: "token-symbol" }, position.tokenSymbol), index.h("span", { class: "token-name" }, position.tokenName)), index.h("div", { class: "staking-value" }, "$", this.formatNumber(position.stakedValue))), index.h("div", { class: "staking-details" }, index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "Staked Amount"), index.h("span", { class: "detail-value" }, parseFloat(position.stakedAmount).toFixed(4), " ", position.tokenSymbol)), index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "APR"), index.h("span", { class: "detail-value apy-value" }, position.apr.toFixed(2), "%")), index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "Rewards"), index.h("span", { class: "detail-value" }, "$", this.formatNumber(position.rewards))), position.unlockDate && (index.h("div", { class: "detail-item" }, index.h("span", { class: "detail-label" }, "Unlock Date"), index.h("span", { class: "detail-value" }, position.unlockDate.toLocaleDateString())))), index.h("div", { class: "staking-actions" }, index.h("euclid-button", { variant: "primary", size: "sm", onClick: () => this.handleStakeMore(position) }, "Stake More"), index.h("euclid-button", { variant: "secondary", size: "sm", onClick: () => this.handleUnstake(position), disabled: position.unlockDate ? position.unlockDate > new Date() : false }, "Unstake"), position.rewards > 0 && (index.h("euclid-button", { variant: "ghost", size: "sm", onClick: () => this.handleClaimRewards(position) }, "Claim"))))))))));
    }
    renderTransactionsTab() {
        const recentTransactions = this.transactions.slice(0, 20);
        return (index.h("div", { class: "transactions-tab" }, index.h("div", { class: "transactions-header" }, index.h("h3", null, "Recent Transactions")), index.h("div", { class: "transactions-list" }, recentTransactions.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,17A1.5,1.5 0 0,0 13.5,15.5A1.5,1.5 0 0,0 12,14A1.5,1.5 0 0,0 10.5,15.5A1.5,1.5 0 0,0 12,17M12,10.5C12.8,10.5 13.5,9.8 13.5,9C13.5,8.2 12.8,7.5 12,7.5C11.2,7.5 10.5,8.2 10.5,9C10.5,9.8 11.2,10.5 12,10.5Z" })), index.h("span", null, "No transactions found"))) : (recentTransactions.map(transaction => (index.h("div", { key: transaction.id, class: "transaction-card", onClick: () => this.handleViewTransaction(transaction) }, index.h("div", { class: "transaction-header" }, index.h("div", { class: "transaction-type" }, index.h("span", { class: "type-label" }, transaction.type.replace('_', ' ').toUpperCase()), index.h("span", { class: {
                'status-badge': true,
                [`status-badge--${transaction.status}`]: true,
            } }, transaction.status)), index.h("div", { class: "transaction-value" }, "$", this.formatNumber(transaction.value))), index.h("div", { class: "transaction-details" }, index.h("div", { class: "transaction-time" }, transaction.timestamp.toLocaleDateString(), " ", transaction.timestamp.toLocaleTimeString()), transaction.tokenA && (index.h("div", { class: "token-amounts" }, index.h("span", null, parseFloat(transaction.amountA || '0').toFixed(4), " ", transaction.tokenA.symbol), transaction.tokenB && transaction.amountB && (index.h("span", null, "\u2192 ", parseFloat(transaction.amountB).toFixed(4), " ", transaction.tokenB.symbol))))), index.h("div", { class: "transaction-hash" }, transaction.hash.slice(0, 10), "...", transaction.hash.slice(-8)))))))));
    }
    render() {
        if (this.loading) {
            return (index.h("div", { class: "portfolio-overview loading" }, index.h("div", { class: "loading-spinner" }), index.h("span", null, "Loading portfolio data...")));
        }
        if (!this.walletAddress) {
            return (index.h("div", { class: "portfolio-overview empty" }, index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,17A1.5,1.5 0 0,0 13.5,15.5A1.5,1.5 0 0,0 12,14A1.5,1.5 0 0,0 10.5,15.5A1.5,1.5 0 0,0 12,17M12,10.5C12.8,10.5 13.5,9.8 13.5,9C13.5,8.2 12.8,7.5 12,7.5C11.2,7.5 10.5,8.2 10.5,9C10.5,9.8 11.2,10.5 12,10.5Z" })), index.h("span", null, "Connect your wallet to view portfolio"))));
        }
        return (index.h("div", { class: "portfolio-overview" }, index.h("div", { class: "portfolio-header" }, index.h("h2", { class: "portfolio-title" }, this.cardTitle), index.h("div", { class: "wallet-info" }, index.h("span", { class: "wallet-address" }, this.walletAddress.slice(0, 6), "...", this.walletAddress.slice(-4)))), index.h("div", { class: "portfolio-tabs" }, index.h("button", { class: {
                'tab-btn': true,
                'tab-btn--active': this.activeTab === 'overview',
            }, onClick: () => this.handleTabChange('overview'), type: "button" }, "Overview"), index.h("button", { class: {
                'tab-btn': true,
                'tab-btn--active': this.activeTab === 'positions',
            }, onClick: () => this.handleTabChange('positions'), type: "button" }, "Positions (", this.poolPositions.length, ")"), index.h("button", { class: {
                'tab-btn': true,
                'tab-btn--active': this.activeTab === 'staking',
            }, onClick: () => this.handleTabChange('staking'), type: "button" }, "Staking (", this.stakingPositions.length, ")"), index.h("button", { class: {
                'tab-btn': true,
                'tab-btn--active': this.activeTab === 'transactions',
            }, onClick: () => this.handleTabChange('transactions'), type: "button" }, "Transactions")), index.h("div", { class: "portfolio-content" }, this.activeTab === 'overview' && this.renderOverviewTab(), this.activeTab === 'positions' && this.renderPositionsTab(), this.activeTab === 'staking' && this.renderStakingTab(), this.activeTab === 'transactions' && this.renderTransactionsTab())));
    }
    get element() { return index.getElement(this); }
};
...
const EuclidSwapCard = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.swapInitiated = index.createEvent(this, "swapInitiated");
        this.tokenSelect = index.createEvent(this, "tokenSelect");
        this.quoteRequested = index.createEvent(this, "quoteRequested");
        ...
        this.openTokenSelector = (type) => {
            ...
            app_store.appStore.openTokenModal(type);
        };
        this.toggleSettings = () => {
        ...
        this.handleSwap = () => {
            ...
            if (!this.inputToken || !this.isWalletConnectedForSwap()) {
                ...
                app_store.appStore.openWalletModal(this.inputToken?.chainUID);
                return;
            }
            if (!this.outputToken || !this.currentQuote)
                return;
            // Emit event to trigger swap execution
            events.dispatchEuclidEvent(events.EUCLID_EVENTS.SWAP.EXECUTE_REQUEST);
    ...
    isWalletConnectedForSwap() {
        if (!this.inputToken)
            return false;
        return wallet_store.walletStore.isWalletConnected(this.inputToken.chainUID);
    }
    getChainDisplayName(chainUID) {
        // Simple mapping - in production this would come from chain config
        const chainNames = {
    ...
    render() {
        return (index.h("div", { key: '5ccf05caa379b87edb753dfae18eb9bb5f20c62b', class: "swap-card" }, index.h("div", { key: '7f2e41e4dad27e696d22668e91fbc3a9306955ba', class: "swap-header" }, index.h("h3", { key: '4bcd02d6ce02f97f8f6567af5fdd15fdcdab92dd', class: "swap-title" }, this.cardTitle), index.h("button", { key: '19f18da33e30257979024612e8f96ec884cc71b2', class: "settings-button", onClick: this.toggleSettings, type: "button", "aria-label": "Swap settings" }, index.h("svg", { key: '8c976b3ee17c14867ebb713f96274809c382af5b', viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { key: 'ceb5ee42a4b96203aa1e0572c6cb82329b986329', d: "M19.14,12.94c0.04-0.3,0.06-0.61,0.06-0.94c0-0.32-0.02-0.64-0.07-0.94l2.03-1.58c0.18-0.14,0.23-0.41,0.12-0.61 l-1.92-3.32c-0.12-0.22-0.37-0.29-0.59-0.22l-2.39,0.96c-0.5-0.38-1.03-0.7-1.62-0.94L14.4,2.81c-0.04-0.24-0.24-0.41-0.48-0.41 h-3.84c-0.24,0-0.43,0.17-0.47,0.41L9.25,5.35C8.66,5.59,8.12,5.92,7.63,6.29L5.24,5.33c-0.22-0.08-0.47,0-0.59,0.22L2.74,8.87 C2.62,9.08,2.66,9.34,2.86,9.48l2.03,1.58C4.84,11.36,4.82,11.69,4.82,12s0.02,0.64,0.07,0.94l-2.03,1.58 c-0.18,0.14-0.23,0.41-0.12,0.61l1.92,3.32c0.12,0.22,0.37,0.29,0.59,0.22l2.39-0.96c0.5,0.38,1.03,0.7,1.62,0.94l0.36,2.54 c0.05,0.24,0.24,0.41,0.48,0.41h3.84c0.24,0,0.44-0.17,0.47-0.41l0.36-2.54c0.59-0.24,1.13-0.56,1.62-0.94l2.39,0.96 c0.22,0.08,0.47,0,0.59-0.22l1.92-3.32c0.12-0.22,0.07-0.47-0.12-0.61L19.14,12.94z M12,15.6c-1.98,0-3.6-1.62-3.6-3.6 s1.62-3.6,3.6-3.6s3.6,1.62,3.6,3.6S13.98,15.6,12,15.6z" })))), this.isSettingsOpen && (index.h("div", { key: 'c53e695401705e1745445077ae97aa907bd3b435', class: "settings-panel" }, index.h("div", { key: '4451f4f0e34592aea5184b133c50673189a6b546', class: "setting-item" }, index.h("label", { key: 'fdedfd88828c25cf3c2c2635c743f38818593249', class: "setting-label" }, "Slippage Tolerance"), index.h("div", { key: '02f4fbb41303e0646841d577648fbcd5a1ac947d', class: "slippage-buttons" }, [0.1, 0.5, 1.0].map((value) => (index.h("button", { class: {
                'slippage-btn': true,
                'slippage-btn--active': this.swapSettings.slippage === value,
            }, onClick: () => this.handleSlippageChange(value), type: "button" }, value, "%"))), index.h("input", { key: 'bcf94b157512ba0325953e290c274d22a641e292', class: "slippage-input", type: "number", min: "0", max: "50", step: "0.1", value: this.swapSettings.slippage, onInput: (e) => this.handleSlippageChange(parseFloat(e.target.value)), placeholder: "Custom" }))), index.h("div", { key: '9b21e42077482bd5d7ba74ce11178c5791ec2d0e', class: "setting-item" }, index.h("label", { key: '03b4cb73fa483d2911a657c183d368ceecc991b8', class: "setting-label" }, "Transaction Deadline"), index.h("div", { key: '2f9c19f67d93eea7dd8dcabb119d9fb02da428c0', class: "deadline-input" }, index.h("input", { key: 'f4d7eee46ea9e96fbccb3d5a95c83cd93ba03686', type: "number", min: "1", max: "4320", value: this.swapSettings.deadline, onInput: (e) => (this.swapSettings = {
                ...this.swapSettings,
                deadline: parseInt(e.target.value),
            }) }), index.h("span", { key: '556bb04c97045abd921652d89969587da3f56ea2' }, "minutes"))))), index.h("div", { key: '37622af2d6a7636b83158a7b30f52501d11b9fae', class: "token-input-section" }, index.h("div", { key: '3c40f0c66a1cee84d7d835af3998e52471988d97', class: "input-header" }, index.h("span", { key: '7ba473eeed5d4309544397a8b55ff8dfaa561835', class: "input-label" }, "From"), this.inputToken?.balance && (index.h("span", { key: '32cd4284ceb8ade0d671449194e814af5ac503d6', class: "balance-label" }, "Balance: ", parseFloat(this.inputToken.balance).toLocaleString()))), index.h("euclid-token-input", { key: '5c60ba44280e556489a3677b31572059dcffcee0', id: "input-amount", value: this.inputAmount, placeholder: "0.0", "show-max": !!this.inputToken?.balance, "token-selectable": false, onMaxClick: this.handleMaxClick }, index.h("div", { key: '73bd918a4f6ad94027cff39c139b443626642eaa', slot: "token", class: "token-selector", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.openTokenSelector('input');
            } }, this.inputToken ? (index.h("div", { class: "selected-token" }, this.inputToken.logoUrl && (index.h("img", { src: this.inputToken.logoUrl, alt: this.inputToken.symbol, class: "token-logo" })), index.h("div", { class: "token-info" }, index.h("span", { class: "token-symbol" }, this.inputToken.symbol), index.h("span", { class: "token-name" }, this.inputToken.name)), index.h("svg", { class: "dropdown-arrow", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" })))) : (index.h("div", { class: "select-token-button" }, index.h("span", null, "Select Token"), index.h("svg", { class: "dropdown-arrow", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" }))))))), index.h("div", { key: '3c175a7880a418b3ccd88d584302ef9d896158de', class: "swap-direction" }, index.h("button", { key: 'd99311933510229a6036e44602d9a818e0e2fcd4', class: "swap-button", onClick: this.handleSwapTokens, type: "button", "aria-label": "Swap token directions" }, index.h("svg", { key: '75d0986cb8630b792b1995379c73234921b3aec7', viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { key: 'e3a7341a4fc43aa909ef04f77b344743c7b2a11f', d: "M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z" })))), index.h("div", { key: '5c8078fcc608db80029cf2f316c315758b7db88b', class: "token-input-section" }, index.h("div", { key: 'af5c0e3fb08a20794351977bbab1b7c43fa3a679', class: "input-header" }, index.h("span", { key: '5512edeb1d9bd56d0bc7d09534fdc79e3f2ca496', class: "input-label" }, "To"), this.outputToken?.balance && (index.h("span", { key: '3c7b2dde2f246d35a5bbab44f634c8dcdf50ea97', class: "balance-label" }, "Balance: ", parseFloat(this.outputToken.balance).toLocaleString()))), index.h("euclid-token-input", { key: 'dd4369d960e2c493495a3472f9b47b5b4b6bbb5a', id: "output-amount", value: this.outputAmount, placeholder: "0.0", disabled: true, loading: this.isQuoting, "token-selectable": false }, index.h("div", { key: '409a15ad3bbbec15b736298c53256b2c5b87179e', slot: "token", class: "token-selector", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.openTokenSelector('output');
            } }, this.outputToken ? (index.h("div", { class: "selected-token" }, this.outputToken.logoUrl && (index.h("img", { src: this.outputToken.logoUrl, alt: this.outputToken.symbol, class: "token-logo" })), index.h("div", { class: "token-info" }, index.h("span", { class: "token-symbol" }, this.outputToken.symbol), index.h("span", { class: "token-name" }, this.outputToken.name)), index.h("svg", { class: "dropdown-arrow", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" })))) : (index.h("div", { class: "select-token-button" }, index.h("span", null, "Select Token"), index.h("svg", { class: "dropdown-arrow", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { d: "M7 10l5 5 5-5z" }))))))), this.currentQuote && (index.h("div", { key: '453abad05c15148a151b5fbcd3a37978b6089017', class: "quote-info" }, index.h("div", { key: 'ab610db9496354b9c11069a0d3d7a69581b1279d', class: "quote-row" }, index.h("span", { key: '83a830f209c7db7b5174792afc933102ad07d401', class: "quote-label" }, "Rate"), index.h("span", { key: '816b977644262173b60a17cdf2b99d196d2a1de6', class: "quote-value" }, "1 ", this.inputToken?.symbol, " = ", this.currentQuote.exchangeRate.toFixed(6), " ", this.outputToken?.symbol)), this.currentQuote.priceImpact > 0.1 && (index.h("div", { key: '5f0e90855a9c77f106ab5c3282e586c7f61a6133', class: "quote-row" }, index.h("span", { key: '67f963c6ffa0c5b9bbd90781e0232e4bfc067fe2', class: "quote-label" }, "Price Impact"), index.h("span", { key: 'cdb8dbaf6111a9c9f5a7a65fff03f92642a315d2', class: {
                'quote-value': true,
                'quote-value--warning': this.currentQuote.priceImpact > 3,
                'quote-value--danger': this.currentQuote.priceImpact > 15,
            } }, this.currentQuote.priceImpact.toFixed(2), "%"))), index.h("div", { key: 'e810fccea9c8fd965097e55f030a42041fff79b3', class: "quote-row" }, index.h("span", { key: 'e978d45bdbdf50f6290b41949bed931e61c052d1', class: "quote-label" }, "Minimum Received"), index.h("span", { key: 'acbdf1315c438c297dd98e1c53e4461151b23892', class: "quote-value" }, this.currentQuote.minimumReceived, " ", this.outputToken?.symbol)), index.h("div", { key: '151a44694c6e2ca171231da32196fb6d4e22b9f6', class: "quote-row" }, index.h("span", { key: 'c8152bdd70e13cbe0108dfc05a8307a591b5c7c3', class: "quote-label" }, "Network Fee"), index.h("span", { key: '491098c5a4618446a0f51075fbcd8cdd855f9da3', class: "quote-value" }, this.currentQuote.gasEstimate, " ETH")))), index.h("euclid-button", { key: '2f1e5369a380a16b083f813196818510c08610cc', variant: "primary", size: "lg", "full-width": true, loading: this.loading, disabled: !this.canSwap(), onClick: this.handleSwap }, this.getSwapButtonText())));
    }
    get element() { return index.getElement(this); }
};
...
const EuclidTokenContent = class {
    constructor(hostRef) {
        ...
        this.handleTokenSelect = (token) => {
            const selectorType = app_store.appStore.state.tokenSelectorType || 'input';
            this.tokenSelect.emit({
                token,
                selectorType
            });
    ...
    render() {
        ...
        return (index.h("div", { key: '53ce19e56ea47206d417d9a2400664b5a7a5b20b', class: "token-content" }, index.h("div", { key: '64d7ec6ed2ebb3d275a1d7d88e271e6fcd07a143', class: "search-section" }, index.h("div", { key: '672bf6ba1cab8061c03fcfc93f7431022ff57ac9', class: "search-input-container" }, index.h("svg", { key: '9b8cc389149d64e2b22c538452e6a1ab9dbc0f5d', class: "search-icon", viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { key: '7a5deb8aa8b63167540a8d6813675ba5bfe7f8a0', d: "M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" })), index.h("input", { key: 'f5e82fd1abbb66389da77bba5db07b700ad75c98', type: "text", class: "search-input", placeholder: "Search tokens...", value: this.searchQuery, onInput: this.handleSearchInput }))), isLoading ? (index.h("div", { class: "loading-state" }, index.h("div", { class: "loading-spinner" }), index.h("span", null, "Loading tokens..."))) : this.filteredTokens.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 64 64", fill: "currentColor" }, index.h("path", { d: "M31.968,0c-1.9626667,28.448-3.552,29.984-32,32c28.448,1.9626667,29.984,3.552,32,32c1.9626667-28.448,3.552-29.984,32-32C35.52,29.984,33.9306667,28.448,31.968,0z" })), index.h("span", null, "No tokens found"))) : (index.h("div", { class: "token-list" }, this.filteredTokens.map(token => (index.h("button", { key: token.tokenId, class: "token-item", onClick: () => this.handleTokenSelect(token), type: "button" }, index.h("div", { class: "token-logo" }, token.logoUrl ? (index.h("img", { src: token.logoUrl, alt: token.symbol })) : (token.symbol.substring(0, 2).toUpperCase())), index.h("div", { class: "token-info" }, index.h("div", { class: "token-symbol" }, token.symbol), index.h("div", { class: "token-name" }, token.name)), token.balance && parseFloat(token.balance) > 0 && (index.h("div", { class: "token-balance" }, this.formatBalance(token.balance))))))))));
    }
...
const EuclidTokenInput = class {
    constructor(hostRef) {
        ...
        this.tokenSelect = index.createEvent(this, "tokenSelect");
        this.maxClick = index.createEvent(this, "maxClick");
        /**
    ...
    setupStoreSubscriptions() {
        ...
        wallet_store.walletStore.onChange('balances', () => {
            this.updateUserBalance();
        });
    }
    updateUserBalance() {
        if (this.token?.symbol) {
            ...
            const connectedWallets = wallet_store.walletStore.getAllConnectedWallets();
            if (connectedWallets.length > 0) {
                const primaryChain = connectedWallets[0].chainUID;
                const balance = wallet_store.walletStore.getWalletBalance(primaryChain, this.token.symbol);
    ...
    render() {
        ...
        return (index.h("div", { key: '5b44f7b2a92848b3e1fc0937350372b916289bd3', class: "token-input-wrapper" }, this.label && (index.h("label", { key: '7859f020522d1cd3cbbd6dc284a7daaf4281b3a2', class: "token-input-label" }, this.label)), index.h("div", { key: '94cb16b07de2c98fec464954011a04a60aeee752', class: containerClass }, index.h("div", { key: '722496353b8b140481bb4bcf798e7791c46e86e6', class: "token-input-main" }, index.h("div", { key: '9e95f7e623d9707a404e84e30fa4379af569309b', class: "input-section" }, index.h("input", { key: '5066ac03e0c13ee715a940c422a51402d28ab171', ref: (el) => this.inputRef = el, type: "text", inputMode: "decimal", placeholder: this.placeholder, value: this.value, disabled: this.disabled, onInput: this.handleInputChange, onFocus: this.handleInputFocus, onBlur: this.handleInputBlur, class: "amount-input" }), this.loading && (index.h("div", { key: '96754332ea2d72e8b4e9a2b5c7b522ed7837f898', class: "loading-spinner" }, index.h("div", { key: 'd65acc61de231819959528a921428a4a5230f6bb', class: "spinner" })))), index.h("div", { key: '40ee299ae0e3cb977cdeef96e719c9eec4a70a65', class: tokenSelectorClass, onClick: this.tokenSelectable && !this.disabled ? this.handleTokenClick : undefined }, index.h("slot", { key: '55ed37a54af107f20ee38bd921b5913dd3a5525d', name: "token" }, this.token ? (index.h("div", { class: "token-info" }, this.token.logoUrl && (index.h("img", { src: this.token.logoUrl, alt: this.token.symbol, class: "token-logo" })), index.h("span", { class: "token-symbol" }, this.token.symbol), this.tokenSelectable && !this.disabled && (index.h("svg", { class: "chevron-icon", viewBox: "0 0 20 20", fill: "currentColor" }, index.h("path", { "fill-rule": "evenodd", d: "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z", "clip-rule": "evenodd" }))))) : (index.h("div", { class: "select-token" }, index.h("span", null, "Select Token"), this.tokenSelectable && !this.disabled && (index.h("svg", { class: "chevron-icon", viewBox: "0 0 20 20", fill: "currentColor" }, index.h("path", { "fill-rule": "evenodd", d: "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))))), (this.showBalance || this.showMax) && this.token && (index.h("div", { key: '429b26ee893b93c3e065d51dac8d60f0cd4352ad', class: "token-input-footer" }, this.showBalance && (this.userBalance || this.token.balance) && (index.h("div", { key: '916d3f57dfb0eb9b60d77c25cb6c844df367ecc3', class: "balance-section" }, index.h("span", { key: 'fef002f0c3672f74166a03cc486a3871a27f4890', class: "balance-label" }, "Balance:"), index.h("span", { key: '664189d28b9f3f5bcb65dc49ae91e8fb226ad6ba', class: "balance-value" }, this.formatBalance(this.userBalance || this.token.balance || '0'), " ", this.token.symbol))), this.showMax && this.token.balance && (index.h("button", { key: '069b22a4b4bd2093cbb1a0896c1a97ae020f76df', class: "max-button", onClick: this.handleMaxClick, disabled: this.disabled, type: "button" }, "MAX"))))), (this.error || this.hasError) && (index.h("div", { key: 'f336014eaaac08df2ecd267ad610347abf7dc0aa', class: "error-message" }, this.error || 'Invalid amount'))));
    }
    static get watchers() { return {
        "value": ["onValueChange"],
        "error": ["onErrorChange"],
...
const EuclidTokensList = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.tokenSelected = index.createEvent(this, "tokenSelected");
        this.filtersChanged = index.createEvent(this, "filtersChanged");
        /**
    ...
    syncWithStore() {
        // Use store data if available, fallback to props
        this.storeTokens = constants.marketStore.state.tokens.length > 0 ? constants.marketStore.state.tokens : this.tokens;
        this.storeLoading = constants.marketStore.state.loading;
        // Debug logging
    ...
    render() {
        ...
        return (index.h("div", { key: '050d62a50ee62befe09e53d54fafcdf73f452f9c', class: "tokens-list" }, index.h("div", { key: '5d37b31e73ea4191c11bdb2ad79f81d25fd862bc', class: "tokens-header" }, index.h("h3", { key: '5e35bad70cb21dc7190b7b699016cb7b4d09ecd0', class: "tokens-title" }, this.cardTitle)), index.h("tokens-filters", { key: '3140d4cf1b2a71efe741443e358d58a03a0d95f2', filters: this.filters, chains: uniqueChains, onFiltersChanged: this.handleFiltersChanged }), index.h("div", { key: '717658bacb32cfa0855ff2aa091ecdf9d9da48e0', class: "tokens-stats" }, index.h("div", { key: '5d64ad9d585ceb74326e2239ae8169c0db8aafe3', class: "stat-item" }, index.h("span", { key: 'a049adddef36f8d1cfe455b3275c68d2c1c0bbb7', class: "stat-label" }, "Total Tokens"), index.h("span", { key: 'bc9b5862fd2970fab105dbb6381888b1c65c33b0', class: "stat-value" }, activeTokens.length)), index.h("div", { key: '22289eb4727ea728baf83d267f4d0ba984fb3103', class: "stat-item" }, index.h("span", { key: '24ee411cc75bc636b280ba1cae61fed6e8d01b9f', class: "stat-label" }, "Filtered"), index.h("span", { key: '65c4e509beb3c0c9abbb7c40f7eddf587a8e5b62', class: "stat-value" }, this.filteredTokens.length)), index.h("div", { key: 'eb46ba0acbd0f5a9a579c498c56caf2c940142b1', class: "stat-item" }, index.h("span", { key: '06ef345e216f2eba90942c61e51ee439b4846725', class: "stat-label" }, "Chains"), index.h("span", { key: '9cd07b196a79629f05aba53e0f6865567cb9f350', class: "stat-value" }, uniqueChains.length))), index.h("div", { key: 'df1b3b2e67710a2fdce02163f4d488b2a26eee04', class: "tokens-content" }, isLoading ? (index.h("tokens-loading", { count: 6 })) : paginatedTokens.length === 0 ? (index.h("div", { class: "empty-state" }, index.h("svg", { viewBox: "0 0 64 64", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M31.968,0c-1.9626667,28.448-3.552,29.984-32,32c28.448,1.9626667,29.984,3.552,32,32c1.9626667-28.448,3.552-29.984,32-32C35.52,29.984,33.9306667,28.448,31.968,0z" })), index.h("span", null, "No tokens found matching your criteria"))) : (index.h("div", { class: "tokens-grid" }, paginatedTokens.map(token => (index.h("token-item", { key: token.tokenId, token: token, onClick: () => this.handleTokenClick(token) })))))), this.totalPages > 1 && (index.h("div", { key: 'fafc78c6d6e2c827b73ea28ea5d6dd47b48460cf', class: "pagination" }, index.h("button", { key: '5c99abaf7fd87ac6f7e4828cd1620511467fd745', class: "pagination-btn", onClick: () => this.handlePageChange(this.currentPage - 1), disabled: this.currentPage === 1, type: "button" }, "Previous"), index.h("div", { key: '138d3bd9639b99c96b07f005d02dc9c044cd8396', class: "pagination-pages" }, Array.from({ length: this.totalPages }, (_, i) => i + 1).map(page => (index.h("button", { key: page, class: {
                'pagination-page': true,
                'pagination-page--active': page === this.currentPage,
            }, onClick: () => this.handlePageChange(page), type: "button" }, page)))), index.h("button", { key: '812508668c82d531fd274cb8085e1880e41e3619', class: "pagination-btn", onClick: () => this.handlePageChange(this.currentPage + 1), disabled: this.currentPage === this.totalPages, type: "button" }, "Next")))));
    }
    static get watchers() { return {
...
const EuclidWalletContent = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.walletConnect = index.createEvent(this, "walletConnect");
    ...
    render() {
        return (index.h("div", { key: '0f602499b579836e01cd2f0f3b649a7003c106b7', class: "wallet-content" }, index.h("div", { key: '96dc8993243289645b68261b499d1877f86531dd', class: "wallet-grid" }, this.walletProviders.map(provider => (index.h("button", { key: provider.id, class: {
                'wallet-card': true,
                'wallet-card--not-installed': !provider.installed
            }, onClick: () => this.handleWalletConnect(provider), type: "button" }, index.h("div", { class: "wallet-icon" }, index.h("span", { class: "wallet-emoji" }, provider.icon)), index.h("div", { class: "wallet-info" }, index.h("div", { class: "wallet-name" }, provider.name), index.h("div", { class: "wallet-description" }, provider.description), !provider.installed && (index.h("span", { class: "install-badge" }, "Install Required")))))))));
    }
};
...
const PoolItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dc9d2b4fe3552af9a5fa9a59bdb57657509a188b', class: "pool-item" }, index.h("div", { key: '95ec851ae36f5d0aa17f7112c14d3ec4e57db7e7', class: "pool-main" }, index.h("div", { key: '6f92145b9276224d0fc700e3b04cf41f72e0cb50', class: "pool-tokens" }, index.h("div", { key: '33420685a41c66ff6872eadeea6d37a405cdefd2', class: "token-logos" }, index.h("img", { key: '3b1191831d3eaae18df9b7b6e83aa2c61771f0ac', src: token1Meta?.image || '/assets/default-token.svg', alt: token1Name, class: `token-logo ${token1Name.toLowerCase().includes('euclid') ? 'light-logo' : ''}`.trim(), onError: (e) => e.target.src = '/assets/default-token.svg' }), index.h("img", { key: '31d7be84d31d42a8f7c5c720c6e306631c84ea91', src: token2Meta?.image || '/assets/default-token.svg', alt: token2Name, class: `token-logo token-logo-overlap ${token2Name.toLowerCase().includes('euclid') ? 'light-logo' : ''}`.trim(), onError: (e) => e.target.src = '/assets/default-token.svg' })), index.h("div", { key: 'e93c5b36b910281fc03ba8ba3629dd7683b5f9dc', class: "pool-details" }, index.h("div", { key: '03a9e4590f9124e8d448bebf532f495691a89711', class: "pool-name" }, token1Name, "/", token2Name), index.h("div", { key: 'f53a7534de1ada89d34cd1284ccdc6ddbadef460', class: "pool-fee" }, "0.3% Fee"))), index.h("div", { key: '64abf2e89df58a70cff07eb6f50a867a32c038fb', class: "pool-metrics" }, index.h("div", { key: '4b297c61a7f46979e777d10dc68d584c6ca6c892', class: "metric" }, index.h("div", { key: '8393d761518209b9b299a2e3b32581a73f6eb0b9', class: "metric-label" }, "APR"), index.h("div", { key: 'e6e98289b1cd93442e14a8ddaa558c7aa907228d', class: "metric-value apy" }, this.formatAPR(this.pool.apr || '0'))), index.h("div", { key: '19d32e50cc9a551028d121f7ab8e5f5d8334f16a', class: "metric" }, index.h("div", { key: 'a9802c427d362f5124ec7a4295de1964cbbf6ac6', class: "metric-label" }, "TVL"), index.h("div", { key: '59d4ba912416adefca7a391a7c871a019c3d2d82', class: "metric-value" }, "$", this.formatNumber(parseFloat(this.pool.total_liquidity || '0')))), index.h("div", { key: '99b66a593b2d9d240cd5942079b02711ccde4394', class: "metric" }, index.h("div", { key: '86b8c90d65bf4016bf6c6c467b609246c91dd83c', class: "metric-label" }, "24h Volume"), index.h("div", { key: '7b125896711e64436def8c31ebe05f1fa62a178e', class: "metric-value" }, "$", this.formatNumber(parseFloat(this.pool.volume_24h || '0')))), index.h("div", { key: '1a710784a632597ce8a26acff0dbd276bdfd4808', class: "metric" }, index.h("div", { key: '1f21a8867242bccb4a7c93b3b1d87edb4265e245', class: "metric-label" }, "24h Fees"), index.h("div", { key: '2f41f2ab3000a0db43bc2475faa74f33b33d0ccb', class: "metric-value" }, "$", this.formatNumber(parseFloat(this.pool.fees_24h || '0')))))), this.walletAddress && this.position && (index.h("div", { key: '9a3038e1d08199280e28dff98bdb6be983efa2f4', class: "pool-position" }, index.h("div", { key: 'd28e29c93cb60522819159f16b770ceaafdb64b5', class: "position-details" }, index.h("div", { key: '7307152e5819dcce3eb8d4f60ac5e4c40009ca2a', class: "position-value" }, "$", this.formatNumber(this.position.value)), index.h("div", { key: 'a0c54e757ded725076cd48a82b1971599decd14b', class: "position-share" }, this.position.shareOfPool.toFixed(4), "% of pool"), this.position.unclaimedRewards && this.position.unclaimedRewards > 0 && (index.h("div", { key: '4eea665e6b1d35f41d77d4c5cadcfd3d8ba02a99', class: "unclaimed-rewards" }, "$", this.formatNumber(this.position.unclaimedRewards), " rewards"))))), index.h("div", { key: 'e36a98f89458839dcf4cdddc5e16267cee900b8c', class: "pool-actions" }, index.h("euclid-button", { key: '561ddad0501af93cb65260512ce289bb5f7a5111', variant: "primary", size: "sm", onClick: () => this.addLiquidity.emit(this.pool) }, "Add Liquidity"), this.position && (index.h("euclid-button", { key: '17e9f4db70bbed9764f9c1b08adbbf92760e7c49', variant: "secondary", size: "sm", onClick: () => this.removeLiquidity.emit({ pool: this.pool, position: this.position }) }, "Remove")), this.position && this.position.unclaimedRewards && this.position.unclaimedRewards > 0 && (index.h("euclid-button", { key: '67b63a632b8133ae946f085f1f39a331790145ec', variant: "ghost", size: "sm", onClick: () => this.claimRewards.emit({ pool: this.pool, position: this.position }) }, "Claim Rewards")))));
    }
};
...
const PoolsFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2d0096cb0e241fc1e7950cecb2f29eb302a23865', class: "pools-filters" }, index.h("input", { key: '9efdb1848a2441ba966a7ccc8f55ab6fa6c60c39', class: "search-input", type: "text", placeholder: "Search pools by token name...", value: this.filters.search, onInput: this.handleSearchChange }), index.h("select", { key: 'b8f7946435df62757758cfddf821dedf2407c6d6', class: "sort-select", onChange: this.handleSortChange }, index.h("option", { key: 'f3c0d129fc6b32934c9e037b68bf62af3309ee90', value: "apr", selected: this.filters.sortBy === 'apr' }, "APR (High to Low)"), index.h("option", { key: '7005cc3d189a26f79aae5d800df63231757c9e36', value: "tvl", selected: this.filters.sortBy === 'tvl' }, "TVL (High to Low)"), index.h("option", { key: '3e52d1332f5910922514ff51ac0e7a563ad65671', value: "volume", selected: this.filters.sortBy === 'volume' }, "Volume (High to Low)"), index.h("option", { key: '5c97b975a46ed88f54ad77446b583295acca2656', value: "fees", selected: this.filters.sortBy === 'fees' }, "Fees (High to Low)"), hasWallet && index.h("option", { key: '9c8d8a6d974381eca35411cb7352582eb0915e9c', value: "myLiquidity", selected: this.filters.sortBy === 'myLiquidity' }, "My Liquidity")), hasWallet && (index.h("label", { key: 'ede2b36982cb925f15c31fcf41b07ef500073764', class: "my-pools-checkbox" }, index.h("input", { key: 'd8983f3a28068d065e1eab71aebc0dfc789da944', type: "checkbox", checked: this.filters.showMyPools, onChange: this.handleMyPoolsToggle }), "My Pools Only"))));
    }
};
...
const PoolsLoading = class {
    ...
    render() {
        return (index.h("div", { key: 'c3e902a4016fe6c7a9870be9e9b2b53b4bc0e6e7', class: "pools-loading" }, Array.from({ length: this.count }, (_, i) => (index.h("div", { key: i, class: "pool-skeleton" }, index.h("div", { class: "skeleton-header" }, index.h("div", { class: "skeleton-tokens" }, index.h("div", { class: "skeleton-avatar" }), index.h("div", { class: "skeleton-avatar skeleton-avatar-overlap" }), index.h("div", { class: "skeleton-text skeleton-text-lg" })), index.h("div", { class: "skeleton-metrics" }, index.h("div", { class: "skeleton-metric" }, index.h("div", { class: "skeleton-text skeleton-text-sm" }), index.h("div", { class: "skeleton-text skeleton-text-md" })), index.h("div", { class: "skeleton-metric" }, index.h("div", { class: "skeleton-text skeleton-text-sm" }), index.h("div", { class: "skeleton-text skeleton-text-md" })), index.h("div", { class: "skeleton-metric" }, index.h("div", { class: "skeleton-text skeleton-text-sm" }), index.h("div", { class: "skeleton-text skeleton-text-md" })))), index.h("div", { class: "skeleton-actions" }, index.h("div", { class: "skeleton-button" }), index.h("div", { class: "skeleton-button" })))))));
    }
};
...
const PoolsStats = class {
    ...
    render() {
        return (index.h("div", { key: '44220a8989bb7d2a6993d5f2068c4f924ccca1e0', class: "pools-stats" }, index.h("div", { key: 'eca1db8b71fd57d096b3d500dcd11b2c594e403c', class: "stat-item" }, index.h("div", { key: 'afa70d4dde8dc7c93b1d0a494a0cbe3f6c12116b', class: "stat-label" }, "Total Pools"), index.h("div", { key: '22cd102b79c2a391637f6a754f3f2a492a82b5ab', class: "stat-value" }, this.totalPools)), index.h("div", { key: '35720df6edc9d6fc0fbacf270a320ed57ceb2476', class: "stat-item" }, index.h("div", { key: 'd26f1482e70ab2830b123abd6961e559bf0c379e', class: "stat-label" }, "Filtered"), index.h("div", { key: '7f6dc5b500029d95d0aba1ab4af94f4e7905f299', class: "stat-value" }, this.filteredPools)), index.h("div", { key: 'f7c75e0117a92bea5b2b848f500de1941bffeb21', class: "stat-item" }, index.h("div", { key: 'bad24732796d76dedfc09bdf3f6ccdbd4b55685b', class: "stat-label" }, "Total TVL"), index.h("div", { key: '45362bd5667eee36b5490a3dcffe9e97df8ad246', class: "stat-value" }, "$", this.formatNumber(this.totalTvl))), this.walletAddress && (index.h("div", { key: '6ea4fa5ba9efa5823d716a16fc83a3831cee5301', class: "stat-item" }, index.h("div", { key: 'cbcfbf1bcc28ce6ddcf3adf07e06216e2c9f7cd8', class: "stat-label" }, "My Positions"), index.h("div", { key: '5c3c01f7c83e2ad1c10782e313d84e25335286d3', class: "stat-value" }, this.userPositions)))));
    }
};
...
const TokenItem = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.tokenClick = index.createEvent(this, "tokenClick");
        this.handleClick = () => {
    ...
    render() {
        ...
        return (index.h("div", { key: 'eb4bbd9c19e38b62c6156272d914eb4f9d7421bf', class: "token-item", onClick: this.handleClick }, index.h("div", { key: 'b2b7d9f6a76fcd553e670e426a0810941d677a78', class: "token-header" }, index.h("div", { key: 'ae5a3a79b115e935fd11cb5333ef4d3c0bfd4c7d', class: "token-logo-container" }, this.token.image ? (index.h("img", { src: this.token.image, alt: this.token.displayName, class: "token-logo", onError: (e) => e.target.style.display = 'none' })) : (index.h("svg", { viewBox: "0 0 64 64", class: "token-logo fallback-logo", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { fill: "currentColor", d: "M31.968,0c-1.9626667,28.448-3.552,29.984-32,32c28.448,1.9626667,29.984,3.552,32,32c1.9626667-28.448,3.552-29.984,32-32C35.52,29.984,33.9306667,28.448,31.968,0z" })))), index.h("div", { key: 'a5d99b4bf585797aa31a7822e691568d5af14b2a', class: "token-info" }, index.h("div", { key: '9fd077ae360f04f42eb99dad1259483fb9bc6e5a', class: "token-name" }, this.token.displayName), index.h("div", { key: '94571d862bfe0add2ee96c813f4a949e760a3f01', class: "token-id" }, this.token.tokenId)), this.token.is_verified && (index.h("div", { key: '49d2d51da02a64f0619207c3052e1921c4527d83', class: "verified-badge", title: "Verified Token" }, index.h("svg", { key: 'e3f18e514cd3c00cf29b795a8a3d4bb3085d93c7', viewBox: "0 0 24 24", fill: "currentColor" }, index.h("path", { key: '2091a8b32411e4757da03b65be5e9de782cc95c7', d: "M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M10,17L6,13L7.41,11.59L10,14.18L16.59,7.59L18,9L10,17Z" }))))), index.h("div", { key: '168fc887fb6b6df14e836096a2fe1f16f4fc5749', class: "token-metrics" }, index.h("div", { key: 'c91deffabcf83a1b97fee275c5e09bab9aa90954', class: "metric-row" }, index.h("span", { key: '1cdfa16d9a1664536349460e21bcede17c812952', class: "metric-label" }, "Price"), index.h("span", { key: '544fb92ada0bb9a573f6253313e8e061404ce45e', class: "metric-value" }, this.formatPrice(this.token.price))), priceChange24h !== 0 && (index.h("div", { key: '9c47f506fc3c90e538d5a28fc9d8a1b036eaf37d', class: "metric-row" }, index.h("span", { key: 'f98270be2cf6bafd527c230ac57942ec54bd86a0', class: "metric-label" }, "24h Change"), index.h("span", { key: 'f06bfaef29b8616f1002eef835684011233bab92', class: {
                'metric-value': true,
                'price-change': true,
                'price-positive': isPositiveChange,
                'price-negative': isNegativeChange,
            } }, this.formatPriceChange(priceChange24h)))), this.token.total_volume_24h > 0 && (index.h("div", { key: '450eab81eb97f2c8d22d568a7e0f09ba97f76cc2', class: "metric-row" }, index.h("span", { key: 'dba22971c3b37026cc51c4e697b95b4fab8275a5', class: "metric-label" }, "24h Volume"), index.h("span", { key: '72a1eab63263fd9df59639934140cd99c6a0edb6', class: "metric-value" }, this.formatVolume(this.token.total_volume_24h)))), index.h("div", { key: '95910e166a886e15be7fe7ff9210efbfb483ab57', class: "metric-row" }, index.h("span", { key: '4ad1f69dac352ccc74f44fbc359fbf86ee6f026f', class: "metric-label" }, "Decimals"), index.h("span", { key: '48b21c6e92e868a209162e2c145e5ee35d164aa0', class: "metric-value" }, this.token.coinDecimal))), this.token.tags && this.token.tags.length > 0 && (index.h("div", { key: '7dce2b91dce07fe085f3adf23628e3af3bc99509', class: "token-tags" }, this.token.tags.slice(0, 3).map(tag => (index.h("span", { key: tag, class: `tag tag--${tag}` }, tag))))), this.token.chain_uids && this.token.chain_uids.length > 0 && (index.h("div", { key: 'c54aa9e5706ecc905d1d4a9b243fdc5fce193982', class: "token-chains" }, index.h("span", { key: 'b463d6ebdc6a1b96865299098f900bc5eeac9218', class: "chains-label" }, "Chains:"), index.h("div", { key: '4402a0c3ccd77456ba0d3bc42666314a032ec713', class: "chains-list" }, this.token.chain_uids.slice(0, 3).map(chain => (index.h("span", { key: chain, class: "chain-badge" }, chain))), this.token.chain_uids.length > 3 && (index.h("span", { key: '33dd583d16bdd004f95128b2cccb4398b2546d96', class: "chain-badge more" }, "+", this.token.chain_uids.length - 3)))))));
    }
};
...
const TokensFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'cfbaf1e8b8fd0afd51f507d5b6f16d432e1df21c', class: "tokens-filters" }, index.h("input", { key: 'ba819794b9ad6736a936bf02b1ea620a89d9c79a', class: "search-input", type: "text", placeholder: "Search tokens by name or symbol...", value: this.filters.search, onInput: this.handleSearchChange }), index.h("select", { key: '7fc0c54ef762143fecbe7f50f46df8a528fca805', class: "sort-select", onChange: this.handleSortChange }, index.h("option", { key: 'beac1b7a37c6fc6e7116ae01ecd8d39bc51ea7f2', value: "name", selected: this.filters.sortBy === 'name' }, "Name (A-Z)"), index.h("option", { key: '5c9cf975621e7857f2d6b3bd83a7af1fd67f9c5e', value: "price", selected: this.filters.sortBy === 'price' }, "Price (High to Low)"), index.h("option", { key: '4b6fbaefdbb9b53ae8360063ff0b3f805d0052fb', value: "volume", selected: this.filters.sortBy === 'volume' }, "Volume (High to Low)"), index.h("option", { key: '3ecfbb4083f5f14172447e29be61b91090dc907f', value: "marketCap", selected: this.filters.sortBy === 'marketCap' }, "Market Cap")), this.chains.length > 0 && (index.h("select", { key: '5b5dd7885cec695c00fc75e07fe4cf96acfd69ca', class: "chain-select", onChange: this.handleChainChange }, index.h("option", { key: 'bffc5dcaf48e9b9bfb679391a51831035fededdd', value: "", selected: this.filters.chainFilter === '' }, "All Chains"), this.chains.map(chain => (index.h("option", { key: chain, value: chain, selected: this.filters.chainFilter === chain }, chain)))))));
    }
};
...
const TokensLoading = class {
    ...
    renderSkeletonCard() {
        return (index.h("div", { class: "token-skeleton" }, index.h("div", { class: "token-skeleton__content" }, index.h("div", { class: "token-skeleton__header" }, index.h("div", { class: "token-skeleton__icon" }), index.h("div", { class: "token-skeleton__info" }, index.h("div", { class: "token-skeleton__line token-skeleton__line--title" }), index.h("div", { class: "token-skeleton__line token-skeleton__line--subtitle" }))), index.h("div", { class: "token-skeleton__stats" }, index.h("div", { class: "token-skeleton__stat" }, index.h("div", { class: "token-skeleton__line token-skeleton__line--small" }), index.h("div", { class: "token-skeleton__line token-skeleton__line--medium" })), index.h("div", { class: "token-skeleton__stat" }, index.h("div", { class: "token-skeleton__line token-skeleton__line--small" }), index.h("div", { class: "token-skeleton__line token-skeleton__line--medium" }))), index.h("div", { class: "token-skeleton__tags" }, index.h("div", { class: "token-skeleton__tag" }), index.h("div", { class: "token-skeleton__tag" })))));
    }
    render() {
        if (!this.show) {
            return null;
        }
        return (index.h("div", { class: "tokens-loading" }, index.h("div", { class: "tokens-skeleton-grid" }, Array.from({ length: this.count }, (_, index$1) => (index.h("div", { key: index$1 }, this.renderSkeletonCard()))))));
    }
};
TokensLoading.style = tokensLoadingCss;

exports.euclid_button = EuclidButton;
exports.euclid_liquidity_card = EuclidLiquidityCard;
exports.euclid_market_data_controller = EuclidMarketDataController;
exports.euclid_modal = EuclidModal;
exports.euclid_pools_list = EuclidPoolsList;
exports.euclid_portfolio_overview = EuclidPortfolioOverview;
exports.euclid_swap_card = EuclidSwapCard;
exports.euclid_token_content = EuclidTokenContent;
exports.euclid_token_input = EuclidTokenInput;
exports.euclid_tokens_list = EuclidTokensList;
exports.euclid_wallet_content = EuclidWalletContent;
exports.pool_item = PoolItem;
exports.pools_filters = PoolsFilters;
exports.pools_loading = PoolsLoading;
exports.pools_stats = PoolsStats;
exports.token_item = TokenItem;
exports.tokens_filters = TokensFilters;
exports.tokens_loading = TokensLoading;
//# sourceMappingURL=euclid-button.euclid-liquidity-card.euclid-market-data-controller.euclid-modal.euclid-pools-list.euclid-portfolio-overview.euclid-swap-card.euclid-token-content.euclid-token-input.euclid-tokens-list.euclid-wallet-content.pool-item.pools-filters.pools-loading.pools-stats.token-item.tokens-filters.tokens-loading.entry.cjs.js.map
