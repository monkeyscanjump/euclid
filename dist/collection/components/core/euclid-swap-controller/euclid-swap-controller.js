...
export class EuclidSwapController {
    ...
    static get is() { return "euclid-swap-controller"; }
    static get states() {
        return {
            "isInitialized": {}
        };
    ...
    static get listeners() {
        return [{
                "name": "euclid:swap:execute-request",
                "method": "handleSwapExecution",
                "target": "window",
                "capture": false,
                "passive": false
            }, {
                "name": "euclid:swap:routes-refresh",
                "method": "handleRouteRefresh",
                "target": "window",
                "capture": false,
                "passive": false
            }, {
                "name": "euclid:swap:routes-stop-polling",
                "method": "handleStopPolling",
                "target": "window",
                "capture": false,
                "passive": false
            }, {
                "name": "euclid:swap:routes-start-polling",
                "method": "handleStartPolling",
                "target": "window",
                "capture": false,
                "passive": false
            }];
...
//# sourceMappingURL=euclid-swap-controller.js.map
